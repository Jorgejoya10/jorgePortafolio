...
const ISO27001: React.FC = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto px-2">
      ...
      {/* Nota / descargo */}
      <p className="mt-2 text-xs md:text-sm text-neutral-600 italic">
        {t("iso27001.page.notice")}
      </p>
      ...
      {/* ¿Qué es un SGSI? (card) */}
      <div className="mt-8 rounded-xl bg-white shadow-[0_6px_24px_rgba(0,0,0,0.08)] border border-neutral-200 p-5 md:p-7">
